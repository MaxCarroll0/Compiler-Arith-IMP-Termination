...
value "aval (Plus (V 0) (N 5)) (\<lambda>x. if x = 0 then 7 else 0)"

text \<open>The same state more concisely:\<close>
value "aval (Plus (V 0) (N 5)) ((\<lambda>x. 0) (0 := 7))"
...
value "asimp (Plus (Plus (N 0) (N 0)) (Plus (V 0) (N 0)))"
